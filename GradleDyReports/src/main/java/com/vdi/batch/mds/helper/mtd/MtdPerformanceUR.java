...
@Component("mtdPerformanceUr")
public class MtdPerformanceUR {
	
	private final Logger logger = LogManager.getLogger(MtdPerformanceUR.class);
	...
	public MtdPerformanceUR() {
		
	}
	
	@Autowired
	public MtdPerformanceUR(TimeTools timeTools) {
