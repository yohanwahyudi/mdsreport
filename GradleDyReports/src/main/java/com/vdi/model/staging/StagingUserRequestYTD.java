...
@Entity
@Table(name = "staging_userrequest_ytd")
public class StagingUserRequestYTD {

	@Id
	@GeneratedValue(strategy = GenerationType.AUTO, generator = "seq12")
	@SequenceGenerator(name = "seq12", sequenceName = "seq12", allocationSize = 100)
